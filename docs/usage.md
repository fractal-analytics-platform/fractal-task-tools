...
1. In the `task_list.py` file of your package, import task models from `fractal_task_tools.task_models` (rather than `fractal_tasks_core.dev.task_models`), as in
```python
